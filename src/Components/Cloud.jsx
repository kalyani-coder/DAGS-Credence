...
import "./Cloud.css";
import CLOUD from "../assets/PNG/Cloud Internship.png";
          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              ...
              <h1 className="ml-title">
               ...
               <p className="lead">
              Learn cloud platforms, services, and deployment models with 3-stage
program featuring hands-on projects, real-world assignments, and industry-
recognized certification.
            ...
            <div className="col-md-6 text-center">
              <img src={CLOUD} className="img-fluid hero-image" alt="ML Internship" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="stages-section">
        ...
        <div className="container">
          ...
          <div className="stage-block">
            <div className="stage-chip">Stage 1: Udemy Online Course</div>
            <ul className="stage-bullets">
              <li className="list"><span>Description of the course</span></li>
              <li className="list"><span>Link to the Udemy course</span></li>
              <li className="list"><span>Additional Study Material ( Optional )</span></li>
     ...
     <div className="stage-chip">Stage 4: Generate Certificte Online.</div><br /><br /> 
     <div className="stage-chip">Stage 5: Send physical Internship experience certificate if needed by user. </div>
