            ...
            <div className="row align-items-center">
              <div className="col-md-8">
                ...
                <p className="about-paragraph">
                 Master Artificial Intelligence and Machine Learning through our comprehensive 3-
stage program featuring hands-on projects, real-world assignments, and industry-
